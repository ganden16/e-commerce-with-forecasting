...
import {forecastbestMethod, getAllMethodsForecast, getAllProducts, getAllTrainTestData} from '@/lib/fetchApi'
...
export default function Peramalan() {
	...
	useEffect(() => {
		...
		// setFormOptional(initialStateFormOptional)
		setResultForecast(null)
	}, [selectedProduct])
						...
						<div className="col-span-2 bg-white p-6 rounded-lg">
							...
							<div className="mb-6">
								...
								<input
									...
									defaultValue={formOptional.step}
									type="number"
									onChange={(e) => {
							...
							<div className="mt-6 bg-white p-6 rounded-lg w-full max-w-4xl">
								...
								<div className="overflow-x-auto">
									<GrafikPeramalan y1={selectedProduct.train_test_data} y2={dataForecast[index]} y3={formOptional.dataUji}
										...
										xText='MINGGU' yText={'PENJUALAN' + ' ' + selectedProduct.name.toUpperCase()}
