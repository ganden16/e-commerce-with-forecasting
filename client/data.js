	...
	return [
		{
			...
			customer: {
				...
				country: 'Canada',
				countryFlagUrl: '/catalyst/flags/ca.svg',
			},
			event: await getEvent('1000'),
		},
		{
			id: 3001,
			url: '/admin/laporan/3001',
			date: 'May 5, 2024',
			amount: {
				usd: '$299.00',
				cad: '$409.13',
			...
			customer: {
				...
				country: 'USA',
				countryFlagUrl: '/catalyst/flags/us.svg',
			},
			event: await getEvent('1001'),
		},
		{
			id: 3002,
			url: '/admin/laporan/3002',
			date: 'Apr 28, 2024',
			amount: {
				usd: '$150.00',
				cad: '$205.25',
	...
	return [
		{
			...
			status: 'On Sale',
			imgUrl: '/catalyst/events/bear-hug.jpg',
			thumbUrl: '/catalyst/events/bear-hug-thumb.jpg',
		},
		{
			id: 1001,
			name: 'Six Fingers — DJ Set',
			url: '/admin/penjualan/1001',
			date: 'Jun 2, 2024',
			time: '8 PM',
			...
			pageViewsChange: '-2.5%',
			status: 'On Sale',
			imgUrl: '/catalyst/events/six-fingers.jpg',
			thumbUrl: '/catalyst/events/six-fingers-thumb.jpg',
		},
		{
			id: 1002,
			name: 'We All Look The Same',
			url: '/admin/penjualan/1002',
			date: 'Aug 5, 2024',
			time: '4 PM',
			...
			pageViewsChange: '-8.0%',
			status: 'Closed',
			imgUrl: '/catalyst/events/we-all-look-the-same.jpg',
			thumbUrl: '/catalyst/events/we-all-look-the-same-thumb.jpg',
		},
		{
			id: 1003,
			name: 'Viking People',
			url: '/admin/penjualan/1003',
			date: 'Dec 31, 2024',
			time: '8 PM',
			...
			status: 'On Sale',
			imgUrl: '/catalyst/events/viking-people.jpg',
			thumbUrl: '/catalyst/events/viking-people-thumb.jpg',
		},
	]
}
